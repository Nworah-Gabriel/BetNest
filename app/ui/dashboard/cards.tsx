...
const Card = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://apiv2.allsportsapi.com/football/?met=Leagues&APIkey=378237d55eab4d7c51a4c0cafa60a8bad4e8db5df39f9c3101421c6289632329');
        if (response.data.success === 1) {
          const limitedLeagues = response.data.result.slice(1, 5);
